/*
    ...
    addressing (2016). Fixed byte clamping for ASL and ROL (2020).
*/
...
const RAMSIZE=1048576;
const VRAMSIZE=1048576;
var RAM=new Array(RAMSIZE);
var VRAM=new Array(VRAMSIZE);
...
function WordAt(addr) {
	return ByteAt(addr)|(ByteAt(0xffff&(addr+1))<<8);
}
