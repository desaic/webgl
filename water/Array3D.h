...
class Array3D {
 public:
  ...
  void Allocate(const Vec3u& gridSize, const T& initVal) {
    Allocate(gridSize[0], gridSize[1], gridSize[2], initVal);
  }
  ...
  inline const T& operator()(unsigned int x, unsigned int y,
