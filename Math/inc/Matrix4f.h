...
class Matrix4f {
 public:
  ...
  Matrix4f(const Vec4f& v0, const Vec4f& v1, const Vec4f& v2, const Vec4f& v3,
  ...
  void setCol(int j, const Vec4f& v);
  ...
  static Matrix4f translation(const Vec3f& rTranslation);
  static Matrix4f rotateX(float radians);
  static Matrix4f rotateY(float radians);
  static Matrix4f rotateZ(float radians);
  static Matrix4f rotation(const Vec3f& rDirection, float radians);
  static Matrix4f scaling(float sx, float sy, float sz);
  static Matrix4f uniformScaling(float s);
  static Matrix4f lookAt(const Vec3f& eye, const Vec3f& center,
                         const Vec3f& up);
  static Matrix4f orthographicProjection(float width, float height, float zNear,
                                         float zFar, bool directX);
  static Matrix4f orthographicProjection(float left, float right, float bottom,
                                         float top, float zNear, float zFar,
                                         bool directX);
  static Matrix4f perspectiveProjection(float fLeft, float fRight,
                                        float fBottom, float fTop, float fZNear,
                                        float fZFar, bool directX);
  static Matrix4f perspectiveProjection(float fovYRadians, float aspect,
                                        float zNear, float zFar, bool directX);
  static Matrix4f infinitePerspectiveProjection(float fLeft, float fRight,
